...
interface Props {
  open: boolean
  onClose: () => void
  onCreate: (data: Partial<SubscriptionTemplateType>) => void
}
...
const SubscriptionTemplateCreateModal = ({ open, onClose, onCreate }: Props) => {
  const [form, setForm] = useState<Partial<SubscriptionTemplateType>>({})
...
export default SubscriptionTemplateCreateModal
